...
public class fels_Runner_1 {
	public static void main(String[] args) throws InterruptedException {
		System.setProperty("webdriver.chrome.driver", 
				"C:\\Users\\DELL\\eclipse-workspace\\Runner_Programs\\Driver\\chromedriver.exe");
		...
		UN.sendKeys("FelciaChar");
		
		WebElement PW = driver.findElement(By.id("password"));
		PW.sendKeys("charl0ttE");
		...
		//Book hotel
		driver.findElement(By.id("first_name")).sendKeys("Felcia");
		
		driver.findElement(By.id("last_name")).sendKeys("Charlotte");
